...
/*3009*/ {0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c, 0x471c},
/*300a*/ {0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666},
/*300b*/ {0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL, 0x9eL},
/*300c*/ {0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL, 0xaeL},
/*300d*/ {0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c, 0x1f5c},
/*300e*/ {0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000, 0xc000},
/*300f*/ {0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666, 0x6666},
/*3010*/ {0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L, 0x19L},
...
{0x2000, 0x00, 0x0e, 1, (void*)&CO_OD_RAM.packNodeID, "Pack Node ID"},
...
{0x2015, 0x00, 0x0e, 1, (void*)&CO_OD_RAM.numberOfExpectedCells, "# Cells Expected"},
{0x2016, 0x00, 0x06, 1, (void*)&CO_OD_RAM.numberOfDetectedCells, "# Cells Detected"},
{0x2017, 0x00, 0x0e, 1, (void*)&CO_OD_RAM.cellmanRefreshRate, "CellMan Refresh Rate"},
{0x2018, 0x00, 0x0e, 1, (void*)&CO_OD_RAM.ambientTempRefreshRate, "Ambient Temp Refresh Rate"},
...
{0x3009, 0x10, 0x8e, 2, (void*)&CO_OD_RAM.minCellVoltage[0], "Min Cell Voltage"},
{0x300a, 0x10, 0x8e, 2, (void*)&CO_OD_RAM.maxCellVoltage[0], "Max Cell Voltage"},
{0x300b, 0x10, 0x0e, 1, (void*)&CO_OD_RAM.minCellTemp[0], "Min Cell Temp"},
{0x300c, 0x10, 0x0e, 1, (void*)&CO_OD_RAM.maxCellTemp[0], "Max Cell Temp"},
{0x300d, 0x10, 0x8e, 2, (void*)&CO_OD_RAM.minCellCurrent[0], "Min Cell Current"},
{0x300e, 0x10, 0x8e, 2, (void*)&CO_OD_RAM.maxCellCurrent[0], "Max Cell Current"},
{0x300f, 0x10, 0x8e, 2, (void*)&CO_OD_RAM.maxCellChargeVoltage[0], "Max Cell Charge Voltage"},
{0x3010, 0x10, 0x0e, 1, (void*)&CO_OD_RAM.cellSOC_Min[0], "Cell SOC Min"},
